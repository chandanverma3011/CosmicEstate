    ...
    switch (section) {
      case 'hero':
        return {
          ...
          bg: 'radial-gradient(circle, rgba(0, 240, 255, 0.2), transparent)',
      ...
      case 'trust':
        return {
          ...
          border: '2px solid rgba(112, 0, 255, 0.6)',
          bg: 'radial-gradient(circle, rgba(112, 0, 255, 0.2), transparent)',
          shadow: '0 0 25px rgba(112, 0, 255, 0.5)',
          animation: 'rotate',
        };
      case 'stats':
        return {
          size: isHovering ? 55 : 38,
          border: '3px solid rgba(0, 240, 255, 1)',
          bg: 'linear-gradient(135deg, rgba(0, 240, 255, 0.3), rgba(112, 0, 255, 0.3))',
          shadow: '0 0 35px rgba(0, 240, 255, 0.8)',
          animation: 'glow',
        };
      case 'features':
        return {
          ...
          bg: 'conic-gradient(from 0deg, rgba(112, 0, 255, 0.2), rgba(0, 240, 255, 0.2), rgba(255, 0, 255, 0.2))',
      ...
      case 'cta':
        return {
          ...
          bg: 'radial-gradient(circle, rgba(0, 240, 255, 0.4), rgba(112, 0, 255, 0.2))',
          shadow: '0 0 40px rgba(0, 240, 255, 1), 0 0 60px rgba(112, 0, 255, 0.5)',
          animation: 'mega-glow',
        };
      default:
        return {
          ...
          shadow: '0 0 20px rgba(112, 0, 255, 0.4)',
          animation: 'none',
        };
    }
  };
  ...
  return (
    <div className="custom-cursor-container fixed inset-0 pointer-events-none z-[9999]">
      ...
      {style.animation !== 'none' && (
        <motion.div
          className={`absolute pointer-events-none ${style.animation === 'pulse' ? 'animate-pulse' :
              style.animation === 'rotate' ? 'animate-spin' :
                style.animation === 'glow' ? 'animate-cosmic-glow' :
                  style.animation === 'spin' ? 'animate-spin' :
                    style.animation === 'mega-glow' ? 'animate-cosmic-glow-pulse' : ''
            }`}
          animate={{
