      ...
      <div className="container-custom relative z-10">
        ...
        <div className="py-12 md:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          >
            <Link to="/" className="flex items-center space-x-3 mb-6 group">
              ...
              <motion.span
                className="text-2xl font-bold text-cosmic-shine drop-shadow-[0_0_10px_rgba(112,0,255,0.5)]"
                whileHover={{
                  scale: 1.03,
            ...
            <div className="space-y-3">
              <a href="#" className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors w-fit">
                ...
                <span className="text-sm md:text-base">123 Cosmic Way, Nebula City, Galaxy</span>
              </a>
              ...
              <a href="mailto:info@cosmicestate.com" className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors w-fit">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <span className="text-sm md:text-base">info@cosmicestate.com</span>
              </a>
            </div>
          </motion.div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-5 h-5 text-primary group-hover:text-white transition-colors relative z-10 drop-shadow-[0_0_8px_rgba(112,0,255,0.5)]" />
                    <motion.div
                    ...
                    <motion.div
                      ...
                      whileHover={{
                        boxShadow: [
                          "0 0 0 0 rgba(112, 0, 255, 0.7)",
                          "0 0 0 15px rgba(112, 0, 255, 0)",
                        ],
                      }}
        ...
        <div className="py-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              © {currentYear} CosmicEstate. All rights reserved. Built with passion for real estate.
            </motion.p>
