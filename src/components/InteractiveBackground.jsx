...
// Particle Background
export const ParticleBackground = ({ color = '#7000FF', count = 50 }) => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(112, 0, 255, 0.3), transparent)',
        }}
        animate={{
      ...
      <motion.div
        ...
        style={{
          backgroundImage: `
            ...
            linear-gradient(to bottom, rgba(112, 0, 255, 0.1) 1px, transparent 1px)
          `,
