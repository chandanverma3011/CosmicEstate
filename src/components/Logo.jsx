...
/**
 * CosmicEstate Luxury Logo
 * Modern skyscraper tower design with crown element - clearly property-focused while unique and cosmic
 */
const Logo = ({ size = 'md', animate = true, className = '' }) => {
  ...
  const LogoContent = () => (
    <div className={`${currentSize.container} ${className} relative rounded-xl bg-gradient-to-br from-[#050511] via-[#0F1221] to-[#050511] flex items-center justify-center shadow-[0_4px_24px_rgba(112,0,255,0.5),0_0_40px_rgba(0,240,255,0.2)] overflow-hidden border-2 border-[#7000FF]/40`}>
      {/* Enhanced radial glow */}
      <div className="absolute inset-0 bg-radial-gradient opacity-30"
        style={{ background: 'radial-gradient(circle at center, rgba(112,0,255,0.25) 0%, transparent 70%)' }}
      />
      ...
      >
        <defs>
          {/* Vibrant Cosmic Gradient for buildings */}
          <linearGradient id="buildingGold" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#00F0FF" />
            <stop offset="30%" stopColor="#7000FF" />
            <stop offset="60%" stopColor="#4A00B3" />
            <stop offset="100%" stopColor="#0F1221" />
          </linearGradient>

          {/* Bright neon for highlights */}
          <linearGradient id="lightGold" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#5CFAFF" />
            <stop offset="50%" stopColor="#A35CFF" />
            <stop offset="100%" stopColor="#5CFAFF" />
          </linearGradient>
          ...
          <linearGradient id="crownGlow" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop offset="100%" stopColor="#B30042" />
          </linearGradient>
        ...
        <g transform="translate(80, 80)">
          ...
          <g transform="translate(0, -55)" filter="url(#crownGlowFilter)">
            ...
            <ellipse cx="0" cy="-6" rx="24" ry="8" fill="#7000FF" opacity="0.3" />
            ...
            <circle cx="-15" cy="-8" r="2.5" fill="#5CFAFF" stroke="#00F0FF" strokeWidth="0.5" />
            <circle cx="-15" cy="-8" r="1.5" fill="#fff" opacity="0.8" />

            <circle cx="0" cy="-12" r="3" fill="#5CFAFF" stroke="#00F0FF" strokeWidth="0.5" />
          ...
          <g>
            ...
            {/* Rooftop detail */}
            <rect x="-18" y="-50" width="36" height="6" fill="#7000FF" opacity="0.3" rx="2" />
              ...
              return (
                <g key={i} transform={`translate(0, ${-40 + i * 11})`}>
                  ...
                  <rect
                    ...
                    stroke={litWindows[i][0] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
                  ...
                  <rect
                    ...
                    stroke={litWindows[i][1] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
                  ...
                  <rect
                    ...
                    stroke={litWindows[i][2] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
            ...
            <line x1="-18" y1="-48" x2="-18" y2="38" stroke="#5CFAFF" strokeWidth="1.5" opacity="0.8" />
            <line x1="18" y1="-48" x2="18" y2="38" stroke="#5CFAFF" strokeWidth="1.5" opacity="0.8" />

            {/* Central pillar accent - brighter */}
            <rect x="-2" y="-48" width="4" height="86" fill="#5CFAFF" opacity="0.2" />

            {/* Building base detail */}
            <rect x="-18" y="34" width="36" height="6" fill="#4A00B3" opacity="0.6" rx="1" />
          </g>
          ...
          <g>
            ...
            {/* Rooftop detail */}
            <rect x="-42" y="-20" width="20" height="4" fill="#5CFAFF" opacity="0.25" rx="1" />
              ...
              return (
                <g key={`left-${i}`} transform={`translate(-32, ${-10 + i * 11})`}>
                  <rect
                    ...
                    stroke={litLeft[i][0] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
                  ...
                  <rect
                    ...
                    stroke={litLeft[i][1] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
            ...
            <line x1="-42" y1="-18" x2="-42" y2="38" stroke="#5CFAFF" strokeWidth="1" opacity="0.6" />
          </g>
          ...
          <g>
            ...
            {/* Rooftop detail */}
            <rect x="22" y="-30" width="20" height="4" fill="#5CFAFF" opacity="0.25" rx="1" />
              ...
              return (
                <g key={`right-${i}`} transform={`translate(32, ${-20 + i * 11})`}>
                  <rect
                    ...
                    stroke={litRight[i][0] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
                  ...
                  <rect
                    ...
                    stroke={litRight[i][1] ? "#00F0FF" : "#1a1a1a"}
                    strokeWidth="0.5"
                    rx="0.5"
            ...
            {/* Building edge highlight */}
            <line x1="42" y1="-28" x2="42" y2="38" stroke="#5CFAFF" strokeWidth="1" opacity="0.6" />
          </g>
          ...
          <g transform="translate(-35, 28)" opacity="0.5">
            <circle cx="0" cy="0" r="3.5" fill="#7000FF" stroke="#00F0FF" strokeWidth="0.8" />
            <circle cx="0" cy="0" r="1.5" fill="#5CFAFF" />
            <rect x="3.5" y="-0.8" width="9" height="1.6" fill="#7000FF" stroke="#00F0FF" strokeWidth="0.5" rx="0.3" />
            <rect x="11" y="-2.5" width="1.5" height="2.5" fill="#7000FF" rx="0.3" />
            <rect x="11" y="0.5" width="1.5" height="1.5" fill="#7000FF" rx="0.3" />
          </g>

          {/* Additional decorative stars/sparkles */}
          <g opacity="0.6">
            <path d="M -52 -15 L -50 -15 L -51 -13 L -52 -15 L -53 -13 Z" fill="#5CFAFF" />
            <path d="M 52 -25 L 54 -25 L 53 -23 L 52 -25 L 51 -23 Z" fill="#5CFAFF" />
            <circle cx="-48" cy="15" r="1" fill="#00F0FF" opacity="0.8" />
            <circle cx="50" cy="5" r="1" fill="#00F0FF" opacity="0.8" />
          </g>
