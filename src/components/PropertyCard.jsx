  ...
  return (
    ...
    >
      ...
      <Link to={`/properties/${property.id}`} className="block h-full">
        <div className="relative backdrop-blur-xl bg-black/40 border border-primary/20 rounded-2xl overflow-hidden hover:border-primary/60 hover:shadow-neon-purple hover:bg-black/60 transition-all duration-300 h-full flex flex-col">
          {/* Property Image */}
          <div className="relative overflow-hidden h-56">
            ...
            >
              <span className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-primary to-secondary text-white text-sm font-bold shadow-neon-blue backdrop-blur-sm">
                {propertyType}
              </span>
            </motion.div>
            ...
            {property.featured && (
              <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-gradient-to-r from-primary to-secondary text-white text-xs font-bold shadow-neon-blue backdrop-blur-sm animate-cosmic-glow">
                Featured
              </div>
            )}
          </div>
          ...
          <div className="p-6 flex-1 flex flex-col">
            {/* Title */}
            <h3 className="text-xl font-bold mb-2 text-white group-hover:text-primary group-hover:drop-shadow-[0_0_12px_rgba(112,0,255,0.8)] transition-all duration-300 line-clamp-1">
              {property.title}
            </h3>

            {/* Location */}
            <div className="flex items-center text-gray-400 group-hover:text-gray-300 mb-4 transition-colors duration-300">
              <MapPin className="w-4 h-4 mr-2 flex-shrink-0 text-primary group-hover:drop-shadow-[0_0_8px_rgba(112,0,255,0.6)]" />
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4 text-sm text-gray-400 group-hover:text-white">
              {bedrooms > 0 && (
                <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-black/50 border border-primary/20 group-hover:border-primary/50 group-hover:bg-black/70 group-hover:shadow-neon-blue transition-all duration-300 flex-shrink-0">
                  <Bed className="w-4 h-4 text-primary group-hover:drop-shadow-[0_0_6px_rgba(112,0,255,0.8)]" />
                  <span className="font-semibold">{bedrooms}</span>
                </div>
              )}
              {bathrooms > 0 && (
                <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-black/50 border border-primary/20 group-hover:border-secondary/50 group-hover:bg-black/70 group-hover:shadow-neon-purple transition-all duration-300 flex-shrink-0">
                  <Bath className="w-4 h-4 text-secondary group-hover:drop-shadow-[0_0_6px_rgba(0,240,255,0.8)]" />
                  <span className="font-semibold">{bathrooms}</span>
                </div>
              )}
              {area > 0 && (
                <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-black/50 border border-primary/20 group-hover:border-primary/50 group-hover:bg-black/70 group-hover:shadow-neon-blue transition-all duration-300 flex-shrink-0">
                  <Maximize className="w-4 h-4 text-primary group-hover:drop-shadow-[0_0_6px_rgba(112,0,255,0.8)]" />
            ...
            <div className="flex items-center justify-between pt-4 border-t border-primary/10 group-hover:border-primary/30 mt-auto transition-colors duration-300">
              <div>
                ...
                <span className="text-2xl font-bold text-primary group-hover:drop-shadow-[0_0_15px_rgba(112,0,255,0.9)] transition-all duration-300">
              ...
              <motion.div
                ...
                className="flex items-center gap-2 text-primary font-bold group-hover:drop-shadow-[0_0_10px_rgba(112,0,255,0.8)] transition-all duration-300"
              >
            ...
            {property.amenities && property.amenities.length > 0 && (
              <div className="mt-3 flex flex-wrap gap-2">
                {property.amenities.slice(0, 2).map((amenity, idx) => (
                  <span
                    key={idx}
                    className="text-xs px-2 py-1 rounded-md bg-primary/10 text-primary border border-primary/20 group-hover:bg-primary/20 group-hover:border-primary/40 group-hover:shadow-neon-blue transition-all duration-300 font-medium"
                  >
                    {amenity}
                  </span>
                ))}
