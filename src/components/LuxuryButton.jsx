...
const LuxuryButton = ({
  ...
  const variants = {
    primary: "bg-gradient-to-r from-primary to-secondary text-white shadow-neon-blue hover:shadow-neon-purple",
    outline: "bg-transparent border-2 border-primary text-primary hover:bg-primary/10 shadow-neon-blue hover:shadow-neon-purple",
    ghost: "bg-transparent text-primary hover:bg-primary/5",
    luxury: "bg-black border-2 border-primary text-primary shadow-neon-purple hover:shadow-cosmic-glow",
  };
