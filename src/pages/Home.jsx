    ...
    <PageTransition>
      <div className="min-h-screen">
        ...
        <section ref={heroRef} data-section="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <ParticleBackground color="#7000FF" count={60} />
          ...
          <motion.div style={{ y, opacity }} className="absolute inset-0 bg-gradient-to-br from-dark-bg via-dark-surface to-dark-bg">
            {/* Cosmic Diagonal Pattern */}
            <div
              className="absolute inset-0 opacity-5"
              style={{
                backgroundImage: `repeating-linear-gradient(45deg, #7000FF 0px, #7000FF 1px, transparent 1px, transparent 60px)`,
              }}
            />
          ...
          <div className="container-custom relative z-10">
            ...
            >
              ...
              <div className="relative backdrop-blur-xl bg-black/40 border border-primary/20 rounded-3xl p-12 md:p-16 shadow-2xl">
                ...
                {/* Cosmic Badge with Glow */}
                <motion.div
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ delay: 0.3, duration: 0.5 }}
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/40 mb-8 backdrop-blur-sm animate-cosmic-glow"
                >
                  <motion.div
                    animate={{ rotate: [0, 360] }}
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  >
                    <Award className="w-4 h-4 text-primary drop-shadow-[0_0_8px_rgba(112,0,255,0.8)]" />
                  </motion.div>
                  <span className="text-sm font-semibold text-primary tracking-wide">Future of Real Estate</span>
                </motion.div>

                {/* Main Heading with Cosmic Animation */}
                <motion.h1
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <span className="text-cosmic-shine drop-shadow-[0_0_30px_rgba(112,0,255,0.5)]">
                    CosmicEstate
                  </span>
                </motion.h1>
                ...
                >
                  <Link to="/properties">
                    <motion.button
                      whileHover={{
                        scale: 1.05,
                        boxShadow: "0 0 40px rgba(112, 0, 255, 0.6), 0 0 60px rgba(112, 0, 255, 0.3)"
                      }}
                      whileTap={{ scale: 0.95 }}
                      className="group relative px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-gradient-to-r from-primary to-secondary text-white font-bold text-base sm:text-lg overflow-hidden shadow-neon-blue min-h-[44px] touch-manipulation w-full sm:w-auto animate-cosmic-shimmer"
                    >
                  ...
                  <Link to="/contact">
                    ...
                    >
                      ...
                      >
                        <Key className="w-5 h-5 group-hover:drop-shadow-[0_0_8px_rgba(112,0,255,0.8)]" />
                      </motion.div>
                      Schedule Viewing
                    </motion.button>
                  </Link>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-full backdrop-blur-xl bg-black/40 border border-primary/10 rounded-2xl p-8 hover:border-primary/30 transition-all duration-300 animate-float">
                      ...
                      <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-6 shadow-neon-blue group-hover:scale-110 group-hover:shadow-neon-purple transition-all duration-300 animate-cosmic-glow`}>
                      ...
                      <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-b-2xl overflow-hidden`}>
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-cosmic-shimmer"></div>
                      </div>
        ...
        <section data-section="features" className="py-20 bg-dark-bg relative overflow-hidden">
          {/* Interactive Background - Gradient Orbs + Particles */}
          <GradientOrbs mousePosition={mousePosition} />
          <ParticleBackground color="#7000FF" count={40} />
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 px-4">
              {[
                ...
                return (
                  ...
                  >
                    <div className="relative backdrop-blur-xl bg-black/40 border border-primary/10 rounded-2xl p-8 h-full hover:border-primary/40 transition-all duration-300 group-hover:shadow-neon-blue">
                      <motion.div
                        className="w-14 h-14 rounded-lg bg-gradient-to-br from-primary to-secondary flex items-center justify-center mb-6 shadow-neon-blue animate-cosmic-glow"
        ...
        <section data-section="cta" className="py-20 bg-gradient-to-b from-dark-surface to-dark-bg relative overflow-hidden">
          ...
          <SpotlightEffect mousePosition={mousePosition} />
          <InteractiveGrid mousePosition={mousePosition} />
          <ParticleBackground color="#7000FF" count={50} />
                ...
                >
                  ...
                  <div className="relative backdrop-blur-xl bg-black/60 border-2 border-primary/20 rounded-3xl p-12 md:p-16 overflow-hidden">
                    ...
                    <div
                      className="absolute inset-0 opacity-5"
                      style={{
                        backgroundImage: `radial-gradient(circle at 2px 2px, #7000FF 1px, transparent 1px)`,
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                      <div className="text-center md:text-left flex-1">
                        ...
                        >
                          <h2 className="text-4xl md:text-6xl font-bold mb-4">
                            <span className="text-cosmic-shine drop-shadow-[0_0_20px_rgba(112,0,255,0.5)]">
                              Browse Properties
                            </span>
                          </h2>
                      ...
                      >
                        <motion.div
                          className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center shadow-neon-blue group-hover:shadow-neon-purple transition-all duration-300 animate-cosmic-glow"
