            ...
            >
              ...
              >
                ...
                <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                  Redefining real estate with cosmic innovation, integrity, and exceptional service
                </p>
              </motion.div>
            </motion.div>
          </div>
            ...
            >
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-12 md:p-16">
                ...
                <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                  <p>
                    Welcome to <span className="text-white font-semibold">CosmicEstate</span>, your premier destination for future-ready real estate.
                    With over 20 years of experience in the industry, we specialize in connecting
                    discerning clients with their dream properties across the universe.
                  </p>
                  <p>
                  ...
                  <p>
                    Whether you're buying, selling, or investing, CosmicEstate offers an
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-12">
              ...
              >
                ...
                <div className="relative backdrop-blur-xl bg-black/40 border-2 border-primary/20 rounded-2xl p-8 hover:border-primary/60 transition-all duration-300 h-full animate-slide-in-left">
                  <motion.div
                    className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center mb-6 shadow-neon-blue"
                    whileHover={{ rotate: 360, scale: 1.2 }}
                    transition={{ duration: 0.6 }}
                  >
                    <Target className="w-8 h-8 text-black drop-shadow-lg" strokeWidth={2.5} />
                  </motion.div>
                  <h3 className="text-2xl font-semibold mb-4 text-primary drop-shadow-[0_0_10px_rgba(112,0,255,0.5)]">Our Mission</h3>
              ...
              >
                ...
                <div className="relative backdrop-blur-xl bg-black/40 border-2 border-secondary/20 rounded-2xl p-8 hover:border-secondary/60 transition-all duration-300 h-full animate-slide-in-right">
                  <motion.div
                    className="w-16 h-16 rounded-xl bg-gradient-to-br from-secondary to-purple-600 flex items-center justify-center mb-6 shadow-neon-purple"
                    whileHover={{ rotate: -360, scale: 1.2 }}
                    transition={{ duration: 0.6 }}
                  >
                    <Award className="w-8 h-8 text-black drop-shadow-lg" strokeWidth={2.5} />
                  </motion.div>
                  <h3 className="text-2xl font-semibold mb-4 text-secondary drop-shadow-[0_0_10px_rgba(0,240,255,0.5)]">Our Vision</h3>
                  <p className="text-gray-300 leading-relaxed group-hover:text-white transition-colors">
