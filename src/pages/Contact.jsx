                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <motion.textarea
                      ...
                      onChange={handleChange}
                      rows="6"
                      className={`w-full px-4 py-3 bg-dark-bg/50 border ${errors.message ? 'border-red-500' : 'border-white/10'
            ...
            <ScrollReveal direction="right" className="lg:col-span-1">
              <div className="space-y-6">
                ...
                >
                  ...
                  <a href="mailto:info@cosmicestate.com" className="text-gray-400 hover:text-primary transition-colors">
                    info@cosmicestate.com
                  </a>
                </motion.div>
